        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">01642-848580</span>

              <a
                href="https://api.whatsapp.com/send?phone=01642848580&text=Hello, more infomation!"
                className="contact_button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">user.id204</span>
